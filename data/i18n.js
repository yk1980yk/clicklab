...
ja: {
  ...
  lead1: '商品を売るためのマーケティングのクリックとフィッシング詐欺のクリック。この2つには共通していることがあります。人間の心理に働きかける、という点です。',
  lead2: '「残り1個」「あと5分」「このまま放置しては危険です」。どれも一度は見たことがあるはずです。こうした表示は、あなたの判断にではなく、あなたの心理に向けて設計されています。ここはその設計を見破る側と作る側の両方から体験する場所です。',
